...
class CobraError extends Error {
  ...
  constructor(status: PvStatus, message: string, messageStack: string[] = [], pvError: PvError | null = null) {
    super(CobraError.errorToString(message, messageStack, pvError));
    this._status = status;
...
class CobraOutOfMemoryError extends CobraError {
  constructor(message: string, messageStack?: string[], pvError: PvError | null = null) {
    ...
    this.name = 'CobraOutOfMemoryError';
  }
}
...
class CobraInvalidArgumentError extends CobraError {
  constructor(message: string, messageStack: string[] = [], pvError: PvError | null = null) {
    ...
    this.name = 'CobraInvalidArgumentError';
  }
}
...
class CobraStopIterationError extends CobraError {
  constructor(message: string, messageStack: string[] = [], pvError: PvError | null = null) {
    ...
    this.name = 'CobraStopIterationError';
  }
}
...
class CobraInvalidStateError extends CobraError {
  constructor(message: string, messageStack: string[] = [], pvError: PvError | null = null) {
    ...
    this.name = 'CobraInvalidStateError';
  }
}
...
class CobraActivationError extends CobraError {
  constructor(message: string, messageStack: string[] = [], pvError: PvError | null = null) {
    ...
    this.name = 'CobraActivationError';
  }
}
...
class CobraActivationLimitReachedError extends CobraError {
  constructor(message: string, messageStack: string[] = [], pvError: PvError | null = null) {
    ...
    this.name = 'CobraActivationLimitReachedError';
  }
}
...
class CobraActivationThrottledError extends CobraError {
  constructor(message: string, messageStack: string[] = [], pvError: PvError | null = null) {
    ...
    this.name = 'CobraActivationThrottledError';
  }
}
...
class CobraActivationRefusedError extends CobraError {
  constructor(message: string, messageStack: string[] = [], pvError: PvError | null = null) {
    ...
    this.name = 'CobraActivationRefusedError';
  }
}

export {
  CobraError,
  CobraOutOfMemoryError,
  CobraIOError,
