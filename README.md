...
1. Before running, replace `String APP_ID = "..."` inside [`MainActivity.java`](/demo/android/Activity/cobra-activity-demo-app/src/main/java/ai/picovoice/cobraactivitydemo/MainActivity.java) with your AppID generated by [Picovoice Console](https://picovoice.ai/console/).
